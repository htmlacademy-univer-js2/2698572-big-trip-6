...
function createOffersTemplate(type, selectedOfferIds, allOffers, isDisabled) {
      ...
      <div class="event__available-offers">
        ${typeOffers.map((offer) => `
          <div class="event__offer-selector">
            <input class="event__offer-checkbox  visually-hidden" id="event-offer-${offer.id}" type="checkbox" name="event-offer-${offer.id}" data-offer-id="${offer.id}" ${selectedOfferIds.includes(offer.id) ? 'checked' : ''} ${isDisabled ? 'disabled' : ''}>
...
function createEditPointTemplate(state, destinations, offers, isNewPoint) {
  ...
  const offersTemplate = createOffersTemplate(type, selectedOfferIds, offers, isDisabled);
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--price">
            ...
            <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${basePrice}" inputmode="numeric" pattern="\\d*" ${isDisabled ? 'disabled' : ''}>
          </div>
